	...
	return (
		<div className="flex flex-col justify-center items-center px-4 sm:px-8 md:px-16 xl:px-40 2xl:px-80 py-8">
			<SectionWrapper bgImage="images/pastel.jpeg">
				...
				>
					<h1 className="text-4xl font-bold font-inter mb-4 text-center tracking-wide text-gray-800">
						Welcome to HerSpace🌸
					</h1>
					<p className=" font-[400] font-modelica text-center home-desc ">
						Empowering women at every stage of life
					</p>
					<div className="flex flex-col items-center justify-center max-w-4xl mx-auto px-5">
						<p className="text-xl wotfard  px-5 py-4">
						...
						<ul className="py-4 text-xl wotfard space-y-3.5 pl-3">
							<li>
