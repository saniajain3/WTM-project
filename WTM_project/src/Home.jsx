...
// 				>
// 					<h1 className="xl:text-4xl sm:text-3xl text-[27px] font-bold font-inter mb-3 text-center tracking-wide text-gray-800">
// 						Welcome to HerSpace🌸
// 					</h1>
// 					<p
// 						className="xl:text-sm text-base   font-modelica text-center home-desc mb-2"
// 						style={{ marginTop: "-6px" }}
// 					>
// 						Empowering women at every stage of life
// 					</p>
// 					<div className="flex flex-col items-center justify-center max-w-4xl mx-auto px-5">
// 						<p className="text-lg md:text-2xl xl:text-2xl wotfard  px-5 py-4">
...
// 						<h1 className="font-bold text-2xl md:text-2xl sm:text-2xl text-center pt-5">
// 							What You'll Find Here:
// 						</h1>

// 						<ul className="py-4 xl:text-xl md:text-xl sm:text-base wotfard space-y-3.5 pl-3">
// 							<li>
...
// 						<p className="text-2xl font-[600] font-poppins pt-4">
// 							Why HerSpace?
// 						</p>
// 						<p className="text-xl wotfard tracking-wide py-3 text-center">
